...
App({
  ...
  onLaunch: function() {
    ...
    //  获取商城名称
    WXAPI.queryConfigBatch('mallName,recharge_amount_min,WITHDRAW_MIN,ALLOW_SELF_COLLECTION,RECHARGE_OPEN,msgtpl_id_list,coupon_open, msgtpl_fx_notify,wxpay_img_url,alipay_img_url').then(function(res) {
      if (res.code == 0) {
